	...
	<div class="data_content">
		...
		<table width="90%" align="center">
			<tr>
				...
				<td>
					<input type="text" id="subject" name="question.subject" value="${question.subject }"  class="input-xxlarge"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="joinTime" class="Wdate" onClick="WdatePicker()" name="question.joinTime" value="<fmt:formatDate value="${question.joinTime }" type="date" pattern="yyyy-MM-dd"/>" />
				</td>
			</tr>
			<tr>
				<td><label>选项一：</label></td>
				<td>
					<input type="text" id="optionA" name="question.optionA" value="${question.optionA }" />
				</td>
			</tr>
			<tr>
				<td><label>选项二：</label></td>
				<td>
					<input type="text" id="optionB" name="question.optionB" value="${question.optionB }" />
				</td>
			</tr>
			<tr>
				<td><label>选项三：</label></td>
				<td>
					<input type="text" id="optionC" name="question.optionC" value="${question.optionC }" />
				</td>
			</tr>
			<tr>
				<td><label>选项四：</label></td>
				<td>
					<input type="text" id="optionD" name="question.optionD" value="${question.optionD }" />
				</td>
			</tr>
			<tr>
				<td><label>题目答案：</label></td>
				<td>
					<input type="text" id="answer" name="question.answer" value="${question.answer }" />&nbsp;&nbsp;(多选题答案用逗号隔开，如"A,D")
				</td>
			</tr>
			<tr>
				<td>
