...
<head>
    ...
    <link href="${pageContext.request.contextPath}/style/managerInfo.css" rel="stylesheet">
...
<div align="center" style="padding-top: 20px;">
    <form action="manager!login" method="post" onsubmit="return checkForm()">
        <table width="1004" height="584" background="image/login.jpg">
            ...
            <tr height="10">
                <td width="68%"></td>
                <td width="10%"><label>账号：</label></td>
                <td><input type="text" id="userName" name="manager.userName" value="${manager.id }"/></td>
                <td width="30%"></td>
            </tr>
            <tr height="10">
                <td width="68%"></td>
